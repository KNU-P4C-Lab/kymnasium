...
class ZeldaAdventureEnv(gym.Env):
    ...
    def step(self, action):
        if action is None:
            self.render()
            return self._generate_obs(), 0.0, False, False, {'step': self._steps}
        ...
        self._link_sprites.user_tick(self._link)
        self._tile_sprites.user_tick(self._link)
        self._enemy_sprites.user_tick(self._link)
