...
from kymnasium.grid_adventure.env import Actions
from kymnasium.util import ManualPlayWrapper
...
class FullyObsWrapper(MiniGridFullyObsWrapper):
    ...
    color: 0=red, 1=green, 2=blue, 3=purple, 4=yellow only for a door, a key, and a ball.
