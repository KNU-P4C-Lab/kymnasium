...
class Agent(kym.Agent):
    ...
    def train(self):
        ...
        print('state', buf_state._shape)
        print('action', buf_action._shape)
        print('log_prob', buf_log_prob._shape)
        print('reward', buf_reward._shape)
        print('value', buf_value._shape)
        print('ret', buf_return._shape)
